...
namespace LES.Core.Model.Seed
{
    public class FrameSeed
    {
        ...
        public static bool CreateControllers(SqlSugarClient sqlSugarClient, string ConnId = null, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_Controller_ClassFileByDBTalbe(sqlSugarClient, ConnId, DbFirstFilePath.FilePath + @"\LES.Core.Api.Controllers", "LES.Core.Api.Controllers", tableNames, "", isMuti);
            return true;
        ...
        public static bool CreateModels(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_Model_ClassFileByDBTalbe(sqlSugarClient, ConnId, DbFirstFilePath.FilePath+@"\LES.Core.Model", "LES.Core.Model.Models", tableNames, "", isMuti);
            return true;
        ...
        public static bool CreateIRepositorys(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_IRepository_ClassFileByDBTalbe(sqlSugarClient, ConnId, DbFirstFilePath.FilePath +@"\LES.Core.IRepository", "LES.Core.IRepository", tableNames, "", isMuti);
            return true;
        ...
        public static bool CreateIServices(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_IServices_ClassFileByDBTalbe(sqlSugarClient, ConnId, DbFirstFilePath.FilePath +@"\LES.Core.IServices", "LES.Core.IServices", tableNames, "", isMuti);
            return true;
        ...
        public static bool CreateRepository(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_Repository_ClassFileByDBTalbe(sqlSugarClient, ConnId, DbFirstFilePath.FilePath +@"\LES.Core.Repository", "LES.Core.Repository", tableNames, "", isMuti);
            return true;
        }
        ...
        public static bool CreateServices(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_Services_ClassFileByDBTalbe(sqlSugarClient, ConnId, DbFirstFilePath.FilePath +@"\LES.Core.Services", "LES.Core.Services", tableNames, "", isMuti);
            return true;
...
namespace " + strNameSpace + @"
{
     ...
     public class {ClassName}Controller : ControllerBase
        {
            ...
            [HttpPost]
            public async Task<MessageModel<PageModel<{ClassName}>>> Get([FromBody] {ClassName}Param param)
            {
                ...
                return new MessageModel<PageModel<{ClassName}>>()
                {
                    msg = ""获取成功"",
                    success = true,
                    response = await _{ClassName}Services.QueryPage(whereExpression, param.page, param.pageSize)
                };
    ...
    public async Task<MessageModel<string>> Delete(int id = 0)
    {
        ...
        /// <param name="isMuti"></param>
        /// <param name="blnSerializable">是否序列化</param>
        private static void Create_Controller_ClassFileByDBTalbe2(
          SqlSugarClient sqlSugarClient,
          string ConnId,
          string strPath,
          string strNameSpace,
...
using LES.Core.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
    ...
    public interface I{ClassName}Services :IBaseServices<{ClassName}>" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
	{
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"using LES.Core.IRepository" + (isMuti ? "." + ConnId + "" : "") + @";
using LES.Core.IRepository.UnitOfWork;
using LES.Core.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
using LES.Core.Repository.Base;
    ...
    public class {ClassName}Repository : BaseRepository<{ClassName}>, I{ClassName}Repository" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
    {
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"
using LES.Core.IServices" + (isMuti ? "." + ConnId + "" : "") + @";
using LES.Core.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
