...
using LES.Core.Extensions;
using LES.Core.Filter;
using LES.Core.Hubs;
using LES.Core.IServices;
using LES.Core.Middlewares;
using LES.Core.Model.Seed;
using LES.Core.Tasks;
...
namespace LES.Core
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, MyContext myContext, ITasksQzServices tasksQzServices, ISchedulerCenter schedulerCenter, IHostApplicationLifetime lifetime)
        {
            ...
            // 封装Swagger展示
            app.UseSwaggerMildd(() => GetType().GetTypeInfo().Assembly.GetManifestResourceStream("LES.Core.Api.index.html"));
            ...
            // 开启QuartzNetJob调度服务
            // 暂时不开启调度服务 【EditBy shaocx,2021-01-19】
