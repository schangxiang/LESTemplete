<template>
  <div id="app">
    <transition v-if="!$route.meta.NoNeedHome"
      ...
      <el-row class="container">
        <el-col :span="24"
          ...
          <el-col :span="10"
                  class="logoban">
            <div :class=" collapsed?'tools collapsed':'tools'"
                 @click="collapse">
              <i class="fa fa-align-justify"></i>
            </div>

            <el-breadcrumb separator="/"
                           class="breadcrumb-inner collapsedLogo">
          ...
          <aside :class="collapsedClass ">
            <el-scrollbar style="height:100%;background: #2f3e52;"
              ...
              <el-menu :default-active="$route.path"
                ...
                <sidebar v-for="(menu,index) in routes"
                         @collaFa="collapseFa"
                         :key="index"
                         :item="menu" />
              </el-menu>
    ...
    <el-dialog title="Unread Messages"
               :class="newsDialogCss"
...
export default {
  ...
  data () {
    return {
      ...
      zModalShadow: false,
      collapsedClass: 'menu-expanded',//menu-expanded
      ispc: false,
      sysUserName: '',//登录昵称
      tdLogo: '',//登录人的头像,默认
      showTdLogo: false,//是否显示DB中的登录人的头像，默认
      showDefaultLogo: true,//是否显示默认的Logo
    ...
    getUserInfoByToken (token) {
      ...
      getUserByToken(loginParams).then(data => {
        ...
        if (!data.success) {
          ...
          debugger
          _this.tdLogo = data.response.tdLogo;
          _this.tdLogo = _this.tdLogo;
          _this.showTdLogo = _this.tdLogo ? true : false;
          _this.showDefaultLogo = _this.tdLogo ? false : true;
  ...
  updated () {
    ...
    if (user) {
      ...
      this.tdLogo = user.tdLogo;
      this.showTdLogo = user.tdLogo ? true : false;
      this.showDefaultLogo = user.tdLogo ? false : true;
