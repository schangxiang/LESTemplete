...
export default {
  ...
  data () {
    return {
      ...
      exportColumnHeader: {
        'CargoType': '货物类型', 'ProjectName': '项目名称',
        'TrackingNo': '跟踪号', 'SalverNo': '托盘号', 'CargoCode': '物料号', 'CargoName': '货物名称', 'CargoNum': '货物数量', 'CargoWeight': '重量', 'CargoModel': '型号', 'DrawingNo': '图纸号', 'ValidityDate': '有效期',
        'InStockDate': '入库时间', 'CreateBy': '创建者',
