...
export default {
  ...
  data () {
    return {
      ...
      currentLesTaskType: 1, // 1是 高压绕线线圈运送任务
      currentLesTaskType2: 2 //  2 是 高压绕线线圈空车运送任务
    }
  },
  methods: {
    //显示 AGV任务阶段列表
    ...
    _getEmptyStationList: function (processName) {
      let para = {
        ...
        StoreAreaCode: 'KCQY_GYRXXQQ', // 高压绕线线圈区
        InStoreSceneEnum: 2 // 2 是高压绕线线圈送货
      }
