...
export default {
  ...
  data () {
    return {
      ...
      currentLesTaskType: 10, // 低压装配线圈运送任务
      currentLesTaskType2: 11, //  低压装配线圈空车运送任务
      StoreAreaCode: 'KCQY_DYZPXQ', // 低压装配线圈发货区
      InStoreSceneEnum: 0, // 这个字段可以不用
      my_dialogTitle: '低压装配线圈发货',
      materialCode: 'WL_DYZPXQ' //低压装配线圈
    }
  },
  methods: {
    //显示 AGV任务阶段列表
  ...
  mounted () {
    ...
    //获取默认物料
    this.getMaterCodeItem(this.materialCode) //高压绕线线圈
    this.setInitAddForm()
