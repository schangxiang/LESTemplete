...
export default {
  ...
  data () {
    return {
      ...
      currentLesTaskType: 8, // 高压装配线圈运送任务
      currentLesTaskType2: 9, //  高压装配线圈空车运送任务
      StoreAreaCode: 'KCQY_GYZPXQ', // 高压装配线圈发货区
      InStoreSceneEnum: 0, // 这个字段可以不用
      my_dialogTitle: '高压装配线圈发货',
      materialCode: 'WL_GYZPXQ' //高压装配线圈
    }
  },
  methods: {
    //显示 AGV任务阶段列表
