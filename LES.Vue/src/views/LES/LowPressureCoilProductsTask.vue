...
export default {
  ...
  data () {
    return {
      ...
      currentLesTaskType: 4 //  4 是低压线圈运送任务
    }
  },
  methods: {
    //显示 AGV任务阶段列表
    ...
    _getEmptyStationList: function (processName) {
      let para = {
        ...
        StoreAreaCode: 'KCQY_DYRXJXQQ', // 低压绕线线圈区
        InStoreSceneEnum: 4 // 4 是 低压线圈送货
      }
  ...
  mounted () {
    ...
    //获取默认物料
    this.getMaterCodeItem('GX_DYRX_DYXQ') //低压浇注线圈
    this.setInitAddForm()
