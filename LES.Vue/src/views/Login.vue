    ...
    <el-form :model="ruleForm2"
      ...
      <div style="margin-bottom: 20px;"
        ...
        <el-radio-group @change="loginAccount"
          ...
          <el-radio-button label="祥子"></el-radio-button>
      ...
      <!--
      <el-form-item style="width:100%;">
        <el-button :loading="loginingMock"
                   style="width:100%;"
                   @click.native.prevent="handleSubmitMock">Mock登录
        </el-button>
      </el-form-item>
-->
    </el-form>
    ...
    GetNavigationBar (uid) {
      ...
      getNavigationBar(loginParams).then(data => {
        ...
        if (!data.success) {
          ...
          _this.$message({
            message: `欢迎 ${userinfo.uRealName}，登录成功！`,
            type: 'success'
          });
          /*
                   _this.$message({
