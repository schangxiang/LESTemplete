  ...
  <section> 
    ...
    <el-table :data="WorkPieces" 
      ...
      <el-table-column type="index" 
                ...
                <el-table-column prop="WorkPieceNo" label="工件码" align="center" > 
          </el-table-column> 
          <el-table-column prop="WorkOrderNo" label="工单号" align="center" > 
          </el-table-column> 
          <el-table-column prop="WorkPieceName" label="工件名称" align="center" > 
          </el-table-column> 
          <el-table-column prop="FirstPlacing" label="一次浇筑" align="center" :formatter="formatterDelFlag" > 
          </el-table-column> 
          <el-table-column prop="SecondPlacing" label="二次浇筑" align="center" :formatter="formatterDelFlag" > 
          </el-table-column> 
          <el-table-column prop="Solidify" label="固化" align="center" :formatter="formatterDelFlag" > 
          </el-table-column> 
          <el-table-column prop="AuditTime" label="审核时间" width="150" align="center" :formatter="formatterDateTime" > 
          </el-table-column> 
    ...
    <el-dialog :title="dialogTitle" 
      ...
      <el-form :model="addForm" 
               ...
               label-width="80px" 
               ref="addForm"> 
                        <el-form-item label="工件码" prop="WorkPieceNo" :rules="[{ required: true, message: '工件码不能为空'}]"> 
                ...
                <el-form-item label="工件名称" prop="WorkPieceName" :rules="[{ required: true, message: '工件名称不能为空'}]"> 
                  <el-input v-model="addForm.WorkPieceName"></el-input> 
                </el-form-item> 
                <el-form-item label="一次浇筑" prop="FirstPlacing" > 
                  <el-switch v-model="addForm.FirstPlacing"></el-switch> 
                </el-form-item> 
                <el-form-item label="二次浇筑" prop="SecondPlacing" > 
                  <el-switch v-model="addForm.SecondPlacing"></el-switch> 
                </el-form-item> 
                <el-form-item label="固化" prop="Solidify" > 
                  <el-switch v-model="addForm.Solidify"></el-switch> 
                </el-form-item> 
                <el-form-item label="审核时间" prop="AuditTime "> 
                  <el-input v-model="addForm.AuditTime"></el-input> 
                </el-form-item> 
...
import { getWorkPieceListPage, removeWorkPiece, editWorkPiece, addWorkPiece } from '../../api/api'; 
...
export default { 
  ...
  data () { 
    return { 
      ...
      tHeader: ['工件码','工单号','工件名称','一次浇筑','二次浇筑','固化','审核时间','创建者','创建时间','修改者','修改时间'],//当前页面列表的表头汉字数组，导出用 
      filterVal: ['WorkPieceNo','WorkOrderNo','WorkPieceName','FirstPlacing','SecondPlacing','Solidify','AuditTime','CreateBy','CreateTime','ModifyBy','ModifyTime'],//当前页面列表的表头属性数组，导出用 
      ...
      searchFormInputPlaceholder: '请输入工件码/工单号/工件名称/操作说明/创建者/修改者',//要给子搜索组件传递的值 
	  searchFormInputAttrs: ['WorkPieceNo','WorkOrderNo','WorkPieceName','OperationRemark','CreateBy','ModifyBy'],//要给子搜索组件传递的属性名 
      formOptions: [ 
                        { 
                   label: '工件码', 
                   prop: 'WorkPieceNo', 
