    ...
    <div style="margin-top:10px;">
      <span class="spanclass"
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;<span class="greenClass"
              style="color: #fff"> 有线圈 </span>
        &nbsp;&nbsp;&nbsp;&nbsp;<span class="emptyClass"
              style="color: #fff"> 有空车 </span>
    ...
    <el-dialog title="站点操作"
      ...
      <div slot="footer"
        ...
        <el-button type="danger"
                   class="footSty"
                   icon="fa fa-car"
                   @click="doClick(6)">设为空车</el-button>
...
import { addHighPressureProductsTask, updateStationIsLock, updateStationIsDeleted, getStockByArea, deleteStockByStationId, getCodeItemsBySetCodeForGX, getStockInfoCollectListPage } from '../../api/api';
...
export default {
  ...
  data () {
    return {
      ...
      singleDivWidth: '10%',
      storeAreaCode: 'KCQY_DYZPXQSHQ', //低压装配线圈收货区
      LesTaskType: 11,//低压装配线圈空车运送任务
      StockInfos: [],
      listLoading: false,
      //定时相关
      timingValue: 10, // 定时频率
