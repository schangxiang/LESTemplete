...
import { addHighPressureProductsTask, updateStationIsLock, updateStationIsDeleted, getStockByArea, deleteStockByStationId, deleteAllAllEmptySalverStation, getCodeItemsBySetCodeForGX, getStockInfoCollectListPage } from '../../api/api';
...
export default {
  ...
  methods: {
    ...
    getStockInfos (formValue) {
      this.listLoading = true;
      var param = {
        storeAreaCode: 'KCQY_DYJZXQQ' //低压浇注线圈区
      }
